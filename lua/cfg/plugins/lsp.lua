return {
  ...
  config = function()
    ...
    local servers = require('cfg.configs.lsp.servers').to_setup
    for _, server in pairs(servers) do
      ...
      local has_custom_opts, server_custom_opts =
          pcall(require, 'cfg.configs.lsp.settings.' .. server)
      ...
      local has_custom_commands, server_custom_commands =
          pcall(require, 'cfg.configs.lsp.commands.' .. server)
